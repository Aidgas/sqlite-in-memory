...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sqlitememory: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sqlitememory ${OBJECTFILES} ${LDLIBSOPTIONS} -pthread -ldl -licui18n -licuuc -licudata -licuio

${OBJECTDIR}/include/buf.o: include/buf.c
	${MKDIR} -p ${OBJECTDIR}/include
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/buf.o include/buf.c

${OBJECTDIR}/include/http_parser.o: include/http_parser.c
	${MKDIR} -p ${OBJECTDIR}/include
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/http_parser.o include/http_parser.c

${OBJECTDIR}/include/inih/cpp/INIReader.o: include/inih/cpp/INIReader.cpp
	${MKDIR} -p ${OBJECTDIR}/include/inih/cpp
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/inih/cpp/INIReader.o include/inih/cpp/INIReader.cpp

${OBJECTDIR}/include/inih/ini.o: include/inih/ini.c
	${MKDIR} -p ${OBJECTDIR}/include/inih
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/inih/ini.o include/inih/ini.c

${OBJECTDIR}/include/jsmn.o: include/jsmn.c
	${MKDIR} -p ${OBJECTDIR}/include
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/jsmn.o include/jsmn.c

${OBJECTDIR}/include/sqlite3.o: include/sqlite3.c
	${MKDIR} -p ${OBJECTDIR}/include
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/sqlite3.o include/sqlite3.c
